...
from presentation.endpoints import auth, charts, agendamentos, contacts, admin, database_config, config, transacoes, caixa
try:
...
app.include_router(caixa.router, prefix="/api/v1/caixa", tags=["cash-register"])
