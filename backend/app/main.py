...
from presentation.endpoints import auth, charts, agendamentos, contacts, admin, database_config, config, transacoes, cash_register, services, resources, units, kea_clients, roles
try:
